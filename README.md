...
Our ai detects criminals through cctv's by scanning faces constantly and  comparing with the "wanted" criminals in our dataset.
 - our project starts with face detection first, and recognizes that there is a face and saves an image of that face in the anchor directory (and we adjusted the webcam to move with the face).
 ...
 - when an criminal is identified, an SMS is sent to police officer numbers (authorities) and the photos in the anchor are saved to the folder of the criminal in the dataset.
