...
Our ai detects criminals through cctv's by scanning faces constantly and  comparing with the "wanted" criminals in our dataset.
 - our project starts with face detection first, and recognizes that there is a face and saves an image of that face in the anchor folder (and we adjusted the webcam to move with the face).
